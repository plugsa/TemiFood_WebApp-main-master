...
function App() {
  ...
  const handleUpload = () => {
    ...
    axios
      .post("https://temi-food-backend-master.vercel.app/uploads", formData)
  ...
  const fetchProduct = async () => {
    try {
      const res = await axios.get(
        "https://temi-food-backend-master.vercel.app/alldata"
      );
      setData(res.data);
                    ...
                    {filterData.map((val, key) => {
                      return (
                        ...
                        >
                          <FoodCard
                            src={
                              "https://temi-food-backend-master.vercel.app/images/" +
                              val.image
                            }
                            name={val.name}
                            price={val.price + " บาท"}
